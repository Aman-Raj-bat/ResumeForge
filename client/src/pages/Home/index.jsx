...
const Home = () => {
  return (
    <PageTransition className="flex-grow flex flex-col">
      ...
      {/* Templates Section */}
      <section id="templates" className="py-24 px-6 bg-surface border-t border-gray-100">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-10 text-gray-900">Professional Templates</h2>
          <p className="text-lg text-gray-600 mb-12 max-w-2xl mx-auto">
            Choose from a variety of ATS-friendly templates designed by HR experts. Whether you're in tech, finance, or creative fields, we have the perfect layout for you.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 opacity-80 cursor-default">
            {[1, 2, 3].map((i) => (
              <div key={i} className="aspect-[1/1.4] bg-gray-100 rounded-lg border border-gray-200 overflow-hidden flex flex-col">
                <div className="h-4 bg-gray-200 w-full"></div>
                <div className="p-6 flex flex-col gap-3 flex-grow">
                  <div className="w-1/3 h-4 bg-gray-300 rounded"></div>
                  <div className="w-1/2 h-3 bg-gray-200 rounded"></div>
                  <div className="mt-4 w-full h-2 bg-gray-200 rounded"></div>
                  <div className="w-full h-2 bg-gray-200 rounded"></div>
                  <div className="w-4/5 h-2 bg-gray-200 rounded"></div>
                  <div className="mt-6 w-1/4 h-3 bg-gray-300 rounded"></div>
                  <div className="mt-2 w-full h-2 bg-gray-200 rounded"></div>
                  <div className="w-full h-2 bg-gray-200 rounded"></div>
                </div>
              </div>
            ))}
